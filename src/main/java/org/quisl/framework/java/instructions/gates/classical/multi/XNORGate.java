...
public class XNORGate extends ClassicalGate {
    ...
    public XNORGate(Boolean inputNo1, Boolean inputNo2) {
    ...
    public XNORGate(Integer inputNo1, Integer inputNo2) throws Exception {
