...
public class NORGate extends ClassicalGate {
    ...
    public NORGate(Boolean inputNo1, Boolean inputNo2) {
    ...
    public NORGate(Integer inputNo1, Integer inputNo2) throws Exception {
