...
public class XORGate extends ClassicalGate {
    ...
    public XORGate(Boolean inputNo1, Boolean inputNo2) {
    ...
    public XORGate(Integer inputNo1, Integer inputNo2) throws Exception {
