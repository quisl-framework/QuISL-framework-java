...
public class NANDGate extends ClassicalGate {
    ...
    public NANDGate(Boolean inputNo1, Boolean inputNo2) {
    ...
    public NANDGate(Integer inputNo1, Integer inputNo2) throws Exception {
