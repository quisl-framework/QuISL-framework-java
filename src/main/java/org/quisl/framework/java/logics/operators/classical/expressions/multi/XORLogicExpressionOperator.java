...
public class XORLogicExpressionOperator extends ClassicalLogicExpressionOperator {
    ...
    public XORLogicExpressionOperator() {

    }

    public XORLogicExpressionOperator(Boolean inputNum1, Boolean inputNum2) {
    ...
    public XORLogicExpressionOperator(Integer inputNum1, Integer inputNum2) throws Exception {
    ...
    public static String[] getLabelsXORTruthTable() {

        return new String[] { "Input #1", "Input #2", "Output" };

    }

    public static Integer[][] getIntegerXORTruthTable() {
    ...
    public static Boolean[][] getBooleanXORTruthTable() {
