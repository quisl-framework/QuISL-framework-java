package org.quisl.framework.java.units.qubits.math.complex;
...
public class ComplexNumber {
     ...
     * The <code>ComplexNumber</code> i (z = 0 - 1i).
     */
    public static final ComplexNumber neg_i = new ComplexNumber(0.0, -1.0);
    ...
    public static ComplexNumber multiply(ComplexNumber z1, ComplexNumber z2) {
        double real = z1.getRe() * z2.getRe() - z1.getIm() * z2.getIm();
        double imaginary = z1.getRe() * z2.getIm() + z1.getIm() * z2.getRe();
    ...
    public static ComplexNumber divide(ComplexNumber z1, ComplexNumber z2) {
        ...
        double div = Math.pow(z2.modulus(), 2);
